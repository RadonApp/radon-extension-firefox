...
exports.main = function() {
    ...
    pageMod.PageMod({
        ...
        contentScriptFile: [self.data.url("jquery-1.10.2.min.js"),
                            self.data.url("jquery-migrate-1.2.1.min.js"),
                            self.data.url("jquery.qtip.min.js"),
        ...
        contentStyleFile: [self.data.url("jquery.qtip.min.css"),
                           self.data.url("status-icon.css")],
        ...
        onAttach: function(worker) {
            worker.port.on('gms.ready', function(data) {
                worker.port.emit('gms.construct', {
                    urls: {
                        icon24: self.data.url('icon24.png'),
